...
int main(int argc, char *argv[])
{
    ...
    pthread_create(&threads[0], NULL, calculate_M1, NULL);

	// calculul matricii M2
    pthread_create(&threads[1], NULL, calculate_M2, NULL);

	// calculul matricii M3
    pthread_create(&threads[2], NULL, calculate_M3, NULL);

	// calculul matricii M4
	pthread_create(&threads[3], NULL, calculate_M4, NULL);

	// calculul matricii M5
    pthread_create(&threads[4], NULL, calculate_M5, NULL);

	// calculul matricii M6
	pthread_create(&threads[5], NULL, calculate_M6, NULL);

	// calculul matricii M7
	pthread_create(&threads[6], NULL, calculate_M7, NULL);
